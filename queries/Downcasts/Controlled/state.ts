...
class State {
    ...
    private controlledDowncasts: number[] = [];
    ...
    public addControlledDowncast(pos: number) {
        this.controlledDowncasts.push(pos);
    }

    public getControlledDowncasts() {
        return this.controlledDowncasts;
    }
}
