...
class State {
    ...
    private controlledDynamicAccess: number[] = [];
    ...
    public addControlledDynamicAccess(pos: number) {
        this.controlledDynamicAccess.push(pos);
    }

    public getControlledDynamicAccesses() {
        return this.controlledDynamicAccess;
    }
}
