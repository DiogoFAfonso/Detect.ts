...
class State {
    ...
    private uncontrolledDynamicAccess: number[] = [];
    ...
    public addUncontrolledDynamicAccess(pos: number) {
        this.uncontrolledDynamicAccess.push(pos);
    }

    public getUncontrolledDynamicAccesses() {
        return this.uncontrolledDynamicAccess;
    }
}
